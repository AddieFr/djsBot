...
module.exports = {
    ...
    execute: async (client, message, args, Discord) => {
        ...
        if (!time) return message.reply('put the time!');
        if (!reason) return message.reply('put a mute reason');
        ...
        message.reply(`${member.user.username} has been muted for ${ms(ms(time))} | Reason: ${reason}`)
